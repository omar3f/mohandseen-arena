...
@section('content')
    <div class="row">
        <div class="col-sm-6">
            ...
            <hr>
            {!! Form::open(['method' => 'post', 'action' => 'Panel\Configs\ShortDescriptionImagesController@store', 'files' => true]) !!}
            ...
            <div class="form-group">
                {!! Form::submit('Create Image', ["class" => "form-control btn btn-primary"]) !!}
            </div>
